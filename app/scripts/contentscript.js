...
window.addEventListener("mouseover", function() {
  ...
  template2 = '<br> <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script> <!-- Latest compiled and minified CSS --> <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.2/css/bootstrap.min.css"> <!-- Optional theme --> <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.2/css/bootstrap-theme.min.css"> <!-- Latest compiled and minified JavaScript --> <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.2/js/bootstrap.min.js"></script> <!-- Split button --> <div class="btn-group"> <button type="button" class="btn btn-danger">Email</button> <button type="button" class="btn btn-danger dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> <span class="caret"></span> <span class="sr-only">Toggle Dropdown</span> </button> <ul class="dropdown-menu" role="menu"> <li><a href="#">Action</a></li> <li><a href="#">Another action</a></li> <li><a href="#">Something else here</a></li> <li class="divider"></li> <li><a href="#">Separated link</a></li> </ul> <a href="https://mail.google.com/tasks/canvas" class="btn btn-danger">Tasks</a> <a href="https://drive.google.com/?tab=wo" class="btn btn-danger">Files</a> <a href="https://www.google.com/calendar" class="btn btn-danger">Calendar</a> <a href="https://plus.google.com/" class="btn btn-danger">Info</a> </div> </div>';
